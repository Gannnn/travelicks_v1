<template>
    <div class="flex justify-center">
        <form @submit.prevent="submit" class="w-4/5">
            ...
            <div v-if="currentStep == steps.STATES">
                <Heading title="Select the state you are in!" subtitle="Help guest find you!" />
            ...
            <div v-show="currentStep == steps.DETAIL_LIVING">
                <div class="flex flex-col">
                    ...
                    <Counter title="Bathrooms" subtitle="How many bathrooms do you have?" @countChange="(n) => bathroomCount = n.value" />
                </div>
            </div>
...
const category = ref('');
const location = ref([]);
const selectedState = ref([]); // Change here
...
const steps = reactive({
    "CATEGORY": 1,
    "LOCATION": 2,
    "STATES": 3, // Fixed the sequence here
    "DETAIL_LIVING": 4,
    "DESCRIPTION": 5,
    "IMAGES": 6,
    "PRICES": 7,
...
function submit() {
    ...
    const form = useForm({
        ...
        state: Number(selectedState.value),
