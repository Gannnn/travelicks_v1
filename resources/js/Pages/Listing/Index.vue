                ...
                <div class="w-full lg:w-7/12 mt-12">
                    <div v-show="!showFormListing">
                        <h1 class="text-6xl font-bold text-[#FF385C]">
                            Licktify Your Location
                        </h1>

                        <h5 class="text-5xl font-bold mt-2">and earn</h5>
                        <p class="text-5xl font-bold mt-5">${{ totalPrice }}</p>
                        <p class="mt-8">
                            <span class="font-bold underline">{{ currentValue }} nights</span>
                            at an estimated price of ${{ price }} per night
                        </p>
