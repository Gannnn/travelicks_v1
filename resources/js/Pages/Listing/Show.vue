<template>
  <Layout title="Put your space in Travelicks">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 md:gap-6 mt-6 mb-">
          <div class="col-span-1 lg:col-span-2">
            ...
            <div class="comment-section mt-4">
              <h1>Reviews</h1>
              <CommentSection :listingId="props.listing.id" :isAuthenticated="$page.props.auth.user != null" />
            </div>
            <!-- Comment Section End -->
          </div>
          <div class="p-10 h-72">
            ...
            <div class="flex gap-2 flex-col">
              <InputLabel for="start_date" value="Select a date range" />
            ...
            <div class="mt-4">
              <span>Share: </span>
              <font-awesome-icon class="text-blue-500 cursor-pointer" :icon="['fab', 'facebook']" />
              <font-awesome-icon class="text-pink-500 cursor-pointer" :icon="['fab', 'instagram']" />
              <font-awesome-icon class="text-blue-400 cursor-pointer" :icon="['fab', 'twitter']" />
              <font-awesome-icon class="text-red-500 cursor-pointer" :icon="['fab', 'youtube']" />
            </div>
          </div>
        </div>
      </div>
...
watch(endDate, (endNewValue, endOldValue) => {
  ...
  let night = Math.floor(diffInMs / 86400000);
  let total = night * props.normalPrice;
